...
var Icon$K = function () {
    return React__default['default'].createElement("img", { width: "220px", height: "50px", src: "/images/mobile-logo.png", alt: "mobile-logo" });
};
...
var Icon$D = function () {
    return React__default['default'].createElement("img", { width: "24px", height: "24px", src: "/images/price-token.png", alt: "price-token" });
};
...
var LinkExternal = function (_a) {
    ...
    return (React__default['default'].createElement(Link, __assign({ external: true }, props),
        children,
        showIcon && React__default['default'].createElement(Icon$F, { color: "primary", ml: "4px" })));
};
...
var Icon$r = function () {
    return React__default['default'].createElement("img", { src: "/images/pageloader.png", alt: "page-loading" });
};
...
var Logo$2 = function (_a) {
    ...
    return React__default['default'].createElement("img", { width: "220px", height: "50px", src: isDark ? "/images/logo-dark.png" : "/images/logo.png", alt: "logo" });
};
...
var StyledLink = styled__default['default'].a(templateObject_1$c || (templateObject_1$c = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n    ", " {\n      display: none;\n    }\n  }\n  .desktop-icon {\n    width: 156px;\n    display: none;\n    ", " {\n      display: block;\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n    ", " {\n      display: none;\n    }\n  }\n  .desktop-icon {\n    width: 156px;\n    display: none;\n    ", " {\n      display: block;\n    }\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink, { as: "a", href: href, "aria-label": "Pancake home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink, { href: href, "aria-label": "Pancake home page" }, innerLogo))));
};
...
var SocialLinks = function () { return (React__default['default'].createElement(Flex, null, socials.map(function (social, index) {
    ...
    if (social.items) {
        return (React__default['default'].createElement(Dropdown, { key: social.label, position: "top", target: React__default['default'].createElement(Icon, __assign({}, iconProps, { mr: mr })) }, social.items.map(function (item) { return (React__default['default'].createElement(Link, { to: item.href, external: true, key: item.label, href: item.href, "aria-label": item.label, color: "textSubtle" }, item.label)); })));
    }
    return (React__default['default'].createElement(Link, { to: social.href, external: true, key: social.label, href: social.href, "aria-label": social.label, mr: mr },
...
var ConnectModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React__default['default'].createElement(HelpLink, { to: "https://docs.pancakeswap.finance/guides/faq#how-do-i-set-up-my-wallet-on-binance-smart-chain", external: true },
...
var AccountModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        ...
        React__default['default'].createElement(Flex, { mb: "32px" },
            React__default['default'].createElement(LinkExternal, { to: "https://bscscan.com/address/" + account, external: true, small: true, mr: "16px" }, "View on BscScan"),
